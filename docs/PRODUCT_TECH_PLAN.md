...
> 当前完成度注记（2026-09-16）：今夜观测、暗夜选址、火烧云和高山云海四个入口已经实现并进入正式导航。本文的“开发阶段”“Phase 2”章节是路线/研究计划，不是当前页面未完成声明；CloudSea Phase 2 仅指周边谷地采样与科学校准扩展。当前模型恢复候选和验证状态见 `docs/GUIDE.md` 与最新工程记录。

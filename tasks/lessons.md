...
- 2026-09-18: 主线文档、候选分支文档和本地计划可能同时存在；接力入口必须在首屏写清 main SHA、活动候选、是否合并/部署，以及计划是否只有授权状态，不能让旧历史章节充当当前事实。
- 2026-09-18: 只读浏览器截图、布局测量和实施计划只能标记为观察/计划；固定 fixture E2E、跨浏览器、真机和生产运行证据必须分别记录，不能互相升级。

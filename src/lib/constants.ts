...
export const DEFAULT_CANDIDATE_SEEDS: CityCandidate[] = [
  ...
  },
  {
    ...
    bortle: 4,
    kind: "mountain",
    note: "雪峰山城银河、云海与萤火虫候选",
  },
  {
    id: "yanshan-gexiancun",
    adcode: 361124,
    province: "江西",
    city: "上饶",
    name: "铅山葛仙村摘星楼",
    latitude: 28.093503,
    longitude: 117.692986,
    elevation: 450,
    bortle: 4,
    kind: "village",
    note: "葛仙村星辰广场与天镜台候选",

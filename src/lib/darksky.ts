...
//   * There is deliberately no geographic/elevation heuristic fallback. A
//     missing raster remains missing data; catalog reference classes are not
//     converted into a measured-looking Bortle/SQM value.

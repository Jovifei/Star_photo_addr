...
const auditRows: AuditRow[] = [
  { title: "地图与光污染图层", status: "已覆盖", target: "Leaflet、VIIRS 2023、暗色底图、省界与地点标记", current: `已接入 ${FINDER_LOCATIONS.length} 个地点和 35 个省界；VIIRS 失败自动降级基础底图` },
    ...
    <main className={styles.page}>
      ...
      <div className={styles.content}>
        ...
        <section className={styles.metrics} aria-label="产品合并指标">
          <div><Map size={17} /><strong>{FINDER_LOCATIONS.length}</strong><span>观星地点快照</span></div>

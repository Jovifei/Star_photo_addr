...
const VERSIONS = [
  {
    ...
    highlights: [
      {
        icon: Sparkles,
        title: "火烧云详情舱：机位朝向与暮光摄影全要素",
        desc: "点击任一火烧云观测点滑出 360px 专属深空详情舱，完整展示太阳升落时刻、地平升落方位角（度数与16方位）、金色时刻/蓝色时刻/暮光时间轴、高/中/低云结构微图表、地平通道阻挡判定与摄影师实战建议。",
      },
      {
        icon: Mountain,
        title: "高山云海详情舱：垂直剖面高差与成海研判",
        desc: "点击名山点位即刻调出专属高山摄影详情舱，直观对比山顶海拔与预估云顶标高、相对高差、云上/云中/云下层位胶囊、近地湿度与微风/大风成海条件判定、日出时刻与日出方位角、经典观景点及机位指南。",
      },
      {
        icon: Layers,
        title: "经典三列摄影工作台自适应布局",
        desc: "火烧云与云海模块均采用「大地图 + 排行榜 + 专属详情舱」三列自适应工作台，配备一键关闭按钮与移动端优雅折叠体验，双倒角 14px 深空玻璃拟态风格浑然一体。",
      },
    ],
  },
  {
